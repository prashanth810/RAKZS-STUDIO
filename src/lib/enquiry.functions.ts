  ...
  <table role="presentation" style="width:100%;max-width:600px;margin:0 auto;background:#fffdf8;border-collapse:collapse;overflow:hidden;border-radius:6px">
    ...
    <tr>
      <td style="padding:32px 40px;background:#151311;text-align:center">
        ...
        <p style="margin:0 0 16px"><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#2a2521;color:#d9b56d;font-size:11px;margin:0 3px">IG</span><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#2a2521;color:#d9b56d;font-size:11px;margin:0 3px">YT</span><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#2a2521;color:#d9b56d;font-size:11px;margin:0 3px">FB</span><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#2a2521;color:#d9b56d;font-size:11px;margin:0 3px">PIN</span></p>
